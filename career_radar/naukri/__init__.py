...
from career_radar.exception import NaukriException
from career_radar.naukri.constant import headers as naukri_headers
from career_radar.naukri.util import (
    is_job_remote,
    parse_job_type,
